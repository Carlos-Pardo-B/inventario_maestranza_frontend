...
const AdministratorPage = () => {
  const adminModules = [
    ...
    {
      title: 'Etiquetas',
      description: 'Administra las etiquetas de productos',
      path: '/product_tag_list',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl p-6 sm:p-8">
            ...
            <p className="text-gray-600 mb-10 max-w-2xl">
              Bienvenido al sistema de administración. Selecciona el módulo que deseas gestionar.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800 mb-6">Resumen rápido</h2>
