                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {categories.map((category) => (
                      <tr key={category.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">{category.codigo}</td>
                        <td className="px-6 py-4 whitespace-normal max-w-xs">{category.descripcion}</td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                          ...
                          <button
                            ...
                            className={`${category.activo ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900'}`}
      ...
      {showDeleteAlert && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 p-6">
            ...
            <p className="mb-6">¿Estás seguro que deseas eliminar esta categoría? Esta acción no se puede deshacer.</p>
